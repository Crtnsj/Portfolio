...
import logo_GBH from "../../assets/logo_GBH.png";
      ...
      <div className="about__layout">
        <div className="about__text--layout">
          ...
          <p className="about__text">
            ...
            <br />
            <br /> Actuellement toujours en études je vous presente par le biais
            de mon portfolio mes experience professionnelles et mes différents
            projets réalisés au cours de mes deux années de BTS SIO option SLAM
          </p>
          <div>
      ...
      <div className="experiencePro">
        ...
        <div>
          ...
          <div className="content_exp">
            ...
            <p>
              Grand Bourg Habitat - 01000 Bourg-en-Bresse | Août 2022 -
              Aujourd’hui
            </p>
        ...
        <div>
          ...
          <div className="content_exp">
            ...
            <p>
              ACG-Synergies - 01000 Bourg-en-Bresse | Janvier 2022 - Mars 2022 |
              Stage
            </p>
            <li>
              Maintien en Condition Opérationnel (MCO) de l’infrastructure
            </li>
            <li>
              Recherche et mise en place d’outils et de procédures pour
              améliorer le MCO
            </li>
          </div>
        </div>
        <div>
          ...
          <div className="content_exp">
            <h3>Technicien systèmes et réseaux</h3>
            <p>
              Préfecture de l'AIN - 01000 Bourg-en-Bresse | Mai 2021 - Juillet
              2021 | Stage
            </p>
