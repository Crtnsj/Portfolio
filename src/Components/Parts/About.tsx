      ...
      <div className="about__layout">
        <div className="about__text--layout">
          ...
          <p className="about__text">
            ...
            <br />
            <br /> Actuellement toujours en études je vous presente par le biais de mon portfolio mes experience professionnelles 
            et mes différents projets réalisés au cours de mes deux années de BTS SIO option SLAM
          </p>
          <div>
